        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          <div className="max-w-3xl">
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
              ...
              <span className="text-[#2ecc8a]">strategic clarity</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
              Expert FP&A, business intelligence, and strategic planning for growing businesses and PE-backed companies.
            </p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center items-center space-x-8 text-gray-400">
            ...
            <div className="text-2xl font-bold">PE Portfolio Companies</div>
            <div className="w-px h-8 bg-gray-300" />
            <div className="text-2xl font-bold">Strategic Partners</div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive financial solutions designed to drive growth and clarity
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Tailored financial solutions for different stages of growth
            </p>
          </div>
              ...
              >
                <div className="relative h-64 overflow-hidden">
                  ...
                  <div className="absolute bottom-6 left-6 right-6">
                    ...
                    <p className="text-gray-300">{segment.subtitle}</p>
                  </div>
                </div>
                <div className="p-8">
                  <p className="text-gray-600 leading-relaxed mb-6">
                    {segment.description.substring(0, 200)}...
                  </p>
                  <Link
                    to="/who-we-serve"
                    className="inline-flex items-center text-[#2ecc8a] font-semibold hover:gap-2 transition-all duration-300"
      ...
      <section className="py-20 bg-[#0a1628] relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Let's discuss how we can help you achieve strategic clarity and drive growth.
          </p>
          <Link
            to="/contact"
